...
export default function StudentReg() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('http://localhost/api/studentRegP.php', inputs)
        axios.get('/api/studentRegP.php')
            .then(response => {
    ...
    return (    
        ...
        <div class="content_reg">
            ...
            <div class="user-details_reg">
              ...
              <div class="input-box_reg">
              <span class="details_reg">Profession</span>
              <input type="text" class="field_reg" name="profession" placeholder="Enter Your Profession" onChange={handleChange}/>
              </div>
  
              <div class="input-box_reg">
              <span class="details_reg">School/College</span>
              <input type="text" class="field_reg" name="school" placeholder="Enter Your School/College" onChange={handleChange}/>
              </div>
